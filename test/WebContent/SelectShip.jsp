...
<div id="section">
                 <form action="SelectShip.jsp"  method="post" name="form" onSubmit="return check();">
	              <tr>
     ...
     <% 
     	String ShipNo1=new String(request.getParameter("ShipNo1"));//getBytes("utf-8"),"GBK");
        ...
        if(conn != null){
            System.out.println("数据库连接成功——游艇查询");             
            String sql="select * from dbo.ship where 船号=" + "'" + ShipNo1 + "'";  
