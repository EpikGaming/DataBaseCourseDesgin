	...
	<tr>
     ...
     <% 
        ...
        Connection conn = DriverManager.getConnection(url,usename,psw);  
            ...
            String sql="SELECT AdminSelect.会员号,COUNT(AdminSelect.订单号) 订单数,SUM(AdminSelect.消费金额) 消费总金额 FROM AdminSelect GROUP BY AdminSelect.会员号;";  
            Statement stmt = conn.createStatement();  
            ResultSet rs=stmt.executeQuery(sql);%>
   <table width=800px rules="all" >
      <tr align="center">
      <td width=33.3%>会员号</td>
      <td width=33.3%>订单数</td>
      <td>消费总金额</td></tr>
      <%
      while(rs.next()){
    ...
    out.println("<td align='center'>"+rs.getString(3)+"</td></tr>");
    }
     %>
