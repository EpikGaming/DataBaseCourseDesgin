...
<div id="section">
	<form action="DeleteCost.jsp"  method="post" name="form3" onSubmit="return check();">
	<tr>
	...
	<td colspan="2"><input name="submit" type="Submit" value="删除" />&nbsp;&nbsp;&nbsp;</td>
     ...
     <% 
        ...
        Connection conn = DriverManager.getConnection(url,usename,psw);  
            ...
            String sql="Select * from AdminSelect"+ ";";  
            Statement stmt = conn.createStatement();  
            ResultSet rs=stmt.executeQuery(sql);%>
   <table width=800px rules="all" >
      <tr align="center">
      <td width=12.5%>订单号</td>
      <td width=12.5%>会员号</td>
      <td width=12.5%>游艇号</td>
      <td width=12.5%>消费时间</td>
      <td width=12.5%>消费金额</td>
      <td width=12.5%>用户名</td>
      <td width=12.5%>性别</td>
      <td>级别</td></tr>
      <%
      while(rs.next()){
    ...
    out.println("<td align='center'>"+rs.getString(3)+"</td>");
   	out.println("<td align='center'>"+rs.getDate(4)+"</td>");
    ...
    out.println("<td align='center'>"+rs.getString(8)+"</td></tr>");
	...
	<br>
     <br>
		          <form action="TotalCost.jsp"  method="post" name="form" onSubmit="return check();">
	              <tr>
	                  <td> </td>
