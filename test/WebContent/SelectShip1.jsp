...
<div id="section">
                 <form action="SelectShip1.jsp"  method="post" name="form" onSubmit="return check();">
	              <tr>
     ...
     <% 
     	String ShipNo=new String(request.getParameter("ShipNo"));//getBytes("utf-8"),"GBK");
        ...
        if(conn != null){
            ...
            String sql="select * from dbo.ship where 船号=" + "'" + ShipNo + "'";  
